...
import kz.kbtu.olx.presentation.activities.ui.chats.FilterChats
import kz.kbtu.olx.presentation.activities.ui.chats.ChatActivity
...
class ChatsAdapter : Adapter<ChatsAdapter.ChatsViewHolder>, Filterable{
    ...
    private fun loadLastMessage(modelChats: Chats, holder: ChatsViewHolder) {
    ...
    private fun loadRecepitUserInfo(modelChats: Chats, holder: ChatsViewHolder) {
